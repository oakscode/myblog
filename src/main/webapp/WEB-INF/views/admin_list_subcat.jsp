...
xhttp.open("GET", "updatesubpriority?value="+name+"&id="+id, true);
xhttp.send();
}
</script>
						...
						<div class="page-title">
							<h4>
								<i class="icon-arrow-left52 position-left"></i> <span
									class="text-semibold">Home</span> Main Category -> Sub Category
							</h4>
						</div>
					</div>
				</div>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<table class="table datatable-sorting">
							...
							<tbody>
								<c:forEach items="${list.subcategory}" var="var">
									<tr>
										<td>${var.id_sc}</td>
										<td>${var.id_user}</td>
										<td> <a href="admin_list_blog?id=${var.id_sc}">${var.title}</a></td>
										<td>${var.active}</td>
										<td><input type="text" value="${var.priority}"
											class="form-control" name="title" id="${var.id_sc}"
											style="border: 1px solid #73AD21; width: 60px; height: 20px;" onblur="pass_data(this.id)"></td>
										<td>${var.blogs}</td>
										<td><a href="blogentry?id_sc=${var.id_sc}"> <i class="icon-pencil7"></i></a></td>
											...
											<ul class="icons-list">
												<li class="dropdown"><a href="#"
													...
													<ul class="dropdown-menu dropdown-menu-right">
														...
														<li><a href="deletesubcat?id_sc=${var.id_sc}&id_mc=${var.id_mc}"><i class="icon-cancel-circle2"></i>Remove</a></li>
													</ul></li>
											</ul>
										</td>
